//
//  SoloTripActivityDetailViewController.swift
//  Coco
//
...
final class SoloTripActivityDetailViewController: UIViewController {
    init(viewModel: SoloTripActivityDetailViewModelProtocol) {
    ...
    private let viewModel: SoloTripActivityDetailViewModelProtocol
    private let thisView: SoloTripActivityDetailView = SoloTripActivityDetailView()
}

extension SoloTripActivityDetailViewController: SoloTripActivityDetailViewModelAction {
...
extension SoloTripActivityDetailViewController: SoloTripActivityDetailViewDelegate {
