//
//  SoloTripActivityDetailView.swift
//  Coco
//
...
protocol SoloTripActivityDetailViewDelegate: AnyObject {
    func notifyPackagesButtonDidTap(shouldShowAll: Bool)
    func notifyPackagesDetailDidTap(with packageId: Int)
}

final class SoloTripActivityDetailView: UIView {
    weak var delegate: SoloTripActivityDetailViewDelegate?
...
extension SoloTripActivityDetailView {
    func setupView() {
...
private extension SoloTripActivityDetailView {
